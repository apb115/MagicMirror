...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["You look so tan!"],
			morning: ["Good morning, Emily!", "Enjoy your day!", "Text your awesome bf!"],
			afternoon: ["I love you!", "Happy summer!", "10/10!"],
			evening: ["Get some sleep!", "You look nice!", "Dream about puppies!"],
